  ...
  return (
    <div className="post w-[33%]  m-auto mb-5 bg-[rgb(50,52,54)] rounded-[15px]">
      <div className="profile flex place-content-between">
        ...
        <div className="report flex gap-4 m-5">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
            fill="currentColor"
            className="bi bi-three-dots scale-150"
            viewBox="0 0 16 16"
          >
      ...
      <div className="interactions flex flex-col gap-2 p-3">
        ...
        <div className="w-[100%]  h-[1px] bg-white opacity-60"></div>
        <div className="functions flex place-content-between">
          <div
            className={`react flex items-center gap-1 cursor-pointer`}
            onClick={() => {
              console.log(isLiked);
              liked();
            }}
